...
enum calcOption
{
	dist=1, hypotenuse, circle, rectangle, square, exit
};
...
void calcHypotenuse();
void calcCircle();
int calcRect(int a, int b);
void calcRectangle();
void calcSquare();

int main()
{
	enum calcOption opt = 0;
...
void calcDistance()
{
	...
	printf("Distance is %.2f", Pitagoras(side1, side2));
}
...
void calcHypotenuse()
{
	...
	printf("Hypotenuse is %.2f", Pitagoras(a, b));
}
...
void calcRectangle()
{
	...
	printf("The area of the rectangle is %d", calcRect(l, w));
}
...
void calcSquare()
{
	...
	printf("The area of the square is %d", calcRect(s, s));
}